...
export default function Header() {
  ...
  return (
    <header className="bg bg-gray-900">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Build Drop</span>
            <img className="h-12 w-auto" src="https://gcdnb.pbrd.co/images/m5wT3eeM9XH5.png?o=1" alt="Build Drop Logo" />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            >
              <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-white-900/5">
                <div className="p-4">
                  {products.map((item) => (
                    <div
                      key={item.name}
